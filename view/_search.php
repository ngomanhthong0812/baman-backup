...
<head>
    ...
    <title>Search Results for "<?php echo $_GET['name']?>" &#8211; Goldsmith &#8211; Modern WooCommerce Theme</title>
        ...
        <div class="max-w-[1540px] m-auto flex">
            ...
            <div class="w-[75%] pl-[1rem]">
                ...
                <div class="container_title_category text-[15px] flex items-center justify-between text-[#7d7d7d]">
                    <span class="title flex">Showing all <?php echo count($productSearch)?> results</span>
                ...
                <div class="relative container_filter-1">
                    ...
                    <div class="product_card product_card1 grid-cols-2 w-[100%] filter-1 px-0 py-[2rem] filter-1-1 relative">
                        ...
                        <?php foreach ($productList as $product) { ?>
                            ...
                            <?php if (in_array($product['name'], $productSearch)) { ?>
                                <a href="detail.php?product_id=<?php echo $product['id']; ?> " type="<?php echo $product['category_name'] ?>"
                    ...
                    <!-- start lọc 2,3,4 -->
                    <div class="product_card product_card2 grid-cols-2 w-[100%] filter-2 hidden px-0 py-[2rem] filter-2-1 relative">
                        <div class="absolute w-[100%] is_search items-center justify-center font-black text-[15px]">
                        </div>
                        <?php foreach ($productList as $product) { ?>
                            <?php if (in_array($product['name'], $productSearch)) { ?>
